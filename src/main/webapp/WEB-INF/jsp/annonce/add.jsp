                    ...
                    <layout:page title="Ajouter une annonce">
                        ...
                        <div class="mx-auto max-w-2xl space-y-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h1 class="text-2xl font-bold tracking-tight">Nouvelle annonce</h1>
                                    <p class="mt-1 text-sm text-zinc-500">Remplissez les informations ci-dessous.</p>
                                </div>
                            ...
                            <div class="rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
                                <form class="space-y-6" method="post"
                                    action="${pageContext.request.contextPath}/AnnonceAdd">
