        ...
        <div class="w-full max-w-md">
            <div class="rounded-lg border border-zinc-200 bg-white p-8 shadow-sm">
                <div class="mb-6 text-center">
                    ...
                    <p class="mt-2 text-sm text-zinc-600">Entrez vos identifiants pour accéder à votre compte</p>
                </div>

                <c:if test="${not empty param.logout}">
                    <div class="mb-4">
                        <ui:alert variant="success" message="Vous êtes déconnecté." />
                    </div>
                </c:if>

                <c:if test="${not empty param.registered}">
                    <div class="mb-4">
                        <ui:alert variant="success" message="Inscription réussie ! Vous pouvez maintenant vous connecter." />
                    </div>
                </c:if>
